...
public interface MessageRecordMapper {
     ...
     * @return
     */
    @Insert({"INSERT INTO message_record (`business_id`, `business_type`, `message_id`, `retries_number`, `status_`, `create_time`) VALUES(#{businessId}, #{businessType}, #{messageId}, #{retriesNumber}, #{status}, #{createTime})"})
